...
///////////////////////////////////////////////////////////////////////////////
// Our vertex data with helper functions.
///////////////////////////////////////////////////////////////////////////////
struct Vertex {
    glm::vec2 pos;
    glm::vec3 color;
...
//
// A struct to check if the queue family is complete...
//
...
private:
    ...
    //
    // Helper function to create a vertex buffer.
    //
    ...
    {
        // If we are minimized, wait it out.
    ...
    //
    //Used to set up how many color, the depth buffer, how many samples to use.
    //
    ...
    //We also take care of all the fixed shaders in this part.
    //
    ...
    //
    // Create a frame buffer for each image views in the swap chain.
    //
    ...
    //
    //Helper function use to fill up our SwapChainSupportDetails.
    //
